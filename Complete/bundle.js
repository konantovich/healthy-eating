...
function calculatorCalory() {
  ...
  firstStartInitLocalSettings('.calculating__choose_big div', 'calculating__choose-item_active'); //Formula
  ...
  function yourHeightWeghtAge(selector) {
    ...
    input.addEventListener('input', item => {
      ...
      switch (input.getAttribute('id')) {
        case 'height':
          height = +input.value; //  console.log(height)
...
/* harmony default export */ __webpack_exports__["default"] = (calculatorCalory);
...
function cards() {
  class MenuForOneDay {
    constructor(name, description, price, srcImage, altImage, parentSelector) {
      this.name = name;
    ...
    if() {
      let srcImage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] :  false || srcImage == '';
  ...
  axios.get('http://localhost:3000/menu').then(data => {
    data.data.forEach(objMenu => {
      new MenuForOneDay(objMenu.title, objMenu.descr, objMenu.price, objMenu.img, objMenu.altImage, '.menu .container', 'menu__item') //'menu__item' пустое можем по Rest добавлять сколько угодно классов css
      .render();
    });
  }); //backend v2
...
function forms(timeToOpenModal) {
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_0__.openModal)('.modal', timeToOpenModal);
...
function openModal(modalWindowSelector, modalOpenTimerId) {
  const modal = document.querySelector(modalWindowSelector); //   console.dir(modal.classList);

  modal.classList.add('show');
  modal.classList.remove('hide');
  document.body.style.overflow = 'hidden';
  console.log(modalOpenTimerId);
  if (modalOpenTimerId) clearInterval(modalOpenTimerId);
}
...
function slider() {
  ...
  console.log(sliderImgs.length); //Total and current index
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const timeToOpenModal = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal', timeToOpenModal), 10000);
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])('[data-modal]', '.modal', timeToOpenModal);
  ...
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_7__["default"])(timeToOpenModal);
});
}();
/******/ })()
;
